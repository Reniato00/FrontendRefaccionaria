...
export const getAllProducts = () => {
  return axios.get('http://nscco.com.mx/radiadoresDiaz/api2/api/Radiadores/ListaRadiadores');
}

export const getProductsByMarcaModeloYear= (marca,modelo,year) => {
  const urlWithParameters = `http://nscco.com.mx/radiadoresDiaz/api2/api/Radiadores/PorMarcaAutoYear?idMarca=${marca}&idAuto=${modelo}&year=${year}`;
